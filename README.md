### This repo contains my solution for Emily Bache Gilded Rose Refactoring Kata (https://github.com/emilybache/GildedRose-Refactoring-Kata).

Info text from original repo:
